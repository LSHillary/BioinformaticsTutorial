#!/bin/bash
#SBATCH --job-name=SoilFire-preprocessing  # Job name
#SBATCH --output=logs/SoilFire-preprocessing_%j.out    # Output file name
#SBATCH --error=logs/SoilFire-preprocessing_%j.err     # Error file name
